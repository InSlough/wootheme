...
add_action('wp_enqueue_scripts', function () {
  ...
  wp_localize_script('main', 'siteVars', array(
    ...
    'translate' => array(
      ...
      'wl_remove_text' => __("Удалено из списка желаний", gV('slug')),
      // 'wl_remove_text' => __("Removed from the wish list", gV('slug')),
      'shop_alert__add_to_cart' => __("Товар добавлен в корзину", gV('slug')),
      // 'shop_alert__add_to_cart' => __("The product was added to the cart", gV('slug')),
    ),
  ));
  //
}, 50);
